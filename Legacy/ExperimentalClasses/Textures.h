...
operator SharedReference<Legacy::Graphics::Texture>() const
{
    ...
    {
        SharedReference<Legacy::Graphics::Texture> texture = load(GetLava_005_MASK_TextureData());
...
operator SharedReference<Legacy::Graphics::Texture>() const
{
    ...
    {
        SharedReference<Legacy::Graphics::Texture> texture = load(GetLava_005_DISP_TextureData());
        cachedTexture = texture;
        cachedTexture->load();
        return texture;
    }
...
operator SharedReference<Legacy::Graphics::Texture>() const
{
    ...
    {
        SharedReference<Legacy::Graphics::Texture> texture = load(GetLava_005_COLOR_TextureData());
        cachedTexture = texture;
        cachedTexture->load();
        return texture;
    }
...
operator SharedReference<Legacy::Graphics::Texture>() const
{
    ...
    {
        SharedReference<Legacy::Graphics::Texture> texture = load(GetLava_005_NORM_TextureData());
        cachedTexture = texture;
        cachedTexture->load();
        return texture;
    }
...
operator SharedReference<Legacy::Graphics::Texture>() const
{
    ...
    {
        SharedReference<Legacy::Graphics::Texture> texture = load(GetLava_005_OCC_TextureData());
        cachedTexture = texture;
        cachedTexture->load();
        return texture;
    }
...
operator SharedReference<Legacy::Graphics::Texture>() const
{
    ...
    {
        SharedReference<Legacy::Graphics::Texture> texture = load(GetLava_005_ROUGH_TextureData());
        cachedTexture = texture;
        cachedTexture->load();
        return texture;
    }
