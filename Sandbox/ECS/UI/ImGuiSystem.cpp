...
void ImGuiSystem::OnLoad()
{

};

void ImGuiSystem::OnUnload()
{
...
void Draw()
{
    ...
    if (ImGui::Begin("Content"))
    {
        ...
        auto images = g_Registry.view<UIViewComponent, UIImageComponent>();
        ...
        auto lables = g_Registry.view<UIViewComponent, UITextComponent>();
